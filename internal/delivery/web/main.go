...
func Start(app *app.App) {
	...
	discussionGroup.POST("/:discussionId/join", discussionController.JoinDiscussion)
	discussionGroup.POST("/:discussionId/leave", discussionController.LeaveDiscussion)
